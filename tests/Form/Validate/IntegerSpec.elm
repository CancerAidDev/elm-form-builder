    ...
    Test.describe "Form.Validate.Integer"
        [ Test.describe "SimpleIntegerField"
            [ HelperSpec.integerFieldTest "no bounds"
                (HelperSpec.integerField { min = Nothing, max = Nothing })
            ...
            , HelperSpec.integerFieldTest "min only"
                (HelperSpec.integerField { min = Just 18, max = Nothing })
            ...
            , HelperSpec.integerFieldTest "max only"
                (HelperSpec.integerField { min = Nothing, max = Just 99 })
            ...
            , HelperSpec.integerFieldTest "min and max"
                (HelperSpec.integerField { min = Just 18, max = Just 99 })
                [ { value = Just 18, name = "at min" }
                , { value = Just 99, name = "at max" }
        ...
        , Test.describe "LinearScaleField"
            ...
            , HelperSpec.integerFieldTest "large scale (1-10)"
                ...
                [ { value = Just 11, error = Validate.GreaterThanMaxOrLessThanMin 1 10, name = "above max" } ]
            ]
        ]
