...
suite =
    Test.describe "Form.Validate.Regex"
        [ Test.describe "validate email"
            [ case HelperSpec.regexNonEmployeeEmailField FieldType.Email of
                Either.Left regexString ->
                    Test.test "regex compiles" <|
                        \() ->
                            Expect.fail regexString

                Either.Right emailField ->
